...
class CooperativesControllerTest < ActionController::TestCase
  ...
  test "should create cooperative" do
    assert_difference('Cooperative.count') do
      post :create, cooperative: { address: @cooperative.address, name: @cooperative.name, numTel: @cooperative.numTel }
    end
  ...
  test "should update cooperative" do
    patch :update, id: @cooperative, cooperative: { address: @cooperative.address, name: @cooperative.name, numTel: @cooperative.numTel }
    assert_redirected_to cooperative_path(assigns(:cooperative))
  end
